...
// using the findUser helper function, creating 'user' object to check against req.body fileds. if user exists and credentials match, initiate session with cookie.
  if (user) {
